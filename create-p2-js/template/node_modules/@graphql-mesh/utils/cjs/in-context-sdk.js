                ...
                for (const fieldName in rootTypeFieldMap) {
                    ...
                    rawSourceContext[rootType.name][fieldName] = ({ root, args, context, info = {
                        ...
                        if (key && argsFromKeys) {
                            ...
                            return (0, utils_1.mapMaybePromise)(onDelegateResult$, () => handleIterationResult(batch_delegate_1.batchDelegateToSchema, batchDelegationOptions, onDelegateHookDones));
                        }
                        else {
                            ...
                            return (0, utils_1.mapMaybePromise)(onDelegateResult$, () => handleIterationResult(delegate_1.delegateToSchema, regularDelegateOptions, onDelegateHookDones));
                        }
                    };
                }
            }
...
function handleIterationResult(delegateFn, delegateOptions, onDelegateHookDones) {
    ...
    return (0, utils_1.mapMaybePromise)(delegationResult$, function handleOnDelegateDone(delegationResult) {
        function setResult(newResult) {
            delegationResult = newResult;
        }
        const onDelegateDoneResult$ = (0, iterateAsync_js_1.iterateAsync)(onDelegateHookDones, onDelegateHookDone => onDelegateHookDone({
