        ...
        */
        ...
        function handleResult(originalResult) {
            if (isAsyncIterable(originalResult)) {
                return mapAsyncIterator(originalResult, singleResult => applyResultTransforms(singleResult, delegationContext, transformedRequestAndContext.transformationContext, subschema.transforms));
            }
            const transformedResult = applyResultTransforms(originalResult, delegationContext, transformedRequestAndContext.transformationContext, subschema.transforms);
