...
import { buildOperationNodeForField, isDocumentNode, mapMaybePromise, memoize1, } from '@graphql-tools/utils';
                ...
                for (const fieldName in rootTypeFieldMap) {
                    ...
                    rawSourceContext[rootType.name][fieldName] = ({ root, args, context, info = {
                        ...
                        if (key && argsFromKeys) {
                            ...
                            return mapMaybePromise(onDelegateResult$, () => handleIterationResult(batchDelegateToSchema, batchDelegationOptions, onDelegateHookDones));
                        }
                        else {
                            ...
                            return mapMaybePromise(onDelegateResult$, () => handleIterationResult(delegateToSchema, regularDelegateOptions, onDelegateHookDones));
                        }
                    };
                }
            }
