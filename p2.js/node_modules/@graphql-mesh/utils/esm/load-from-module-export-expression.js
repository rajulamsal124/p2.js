...
export function loadFromModuleExportExpression(expression, options) {
    ...
    return mapMaybePromise(tryImport(modulePath, cwd, importFn), mod => mod[exportName] || (mod.default && mod.default[exportName]) || mod.default || mod);
}
function tryImport(modulePath, cwd, importFn) {
    return mapMaybePromise(importFn(modulePath), m => m, () => {
